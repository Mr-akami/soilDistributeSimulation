...
def room_to_rgb(room, room_structure=None):
    ...
    player_has_box_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'player_has_box.png')))
    player_has_box = imageio.imread(player_has_box_filename)
    ...
    surfaces = [wall, floor, box_target, box_on_target, box, player, player_on_target, player_has_box]
